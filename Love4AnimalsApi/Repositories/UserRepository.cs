...
public class UserRepository : IUserRepository
{
    ...
    {
        this.Users = [];
        this.Users.Add(new(1, "Nazaret", "nazaret@gmail.com", "1234", "https://picsum.photos/200"));
        this.Users.Add(new(2, "Maria", "maria@gmail.com", "5678", "https://picsum.photos/201"));
        this.Users.Add(new(3, "Juan", "juan@gmail.com", "9012", "https://picsum.photos/202"));
    }
    public List<User> GetUsers()
    {
        return this.Users;
